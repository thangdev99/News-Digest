...
class SearchNewsScreenTest {
    ...
    fun searchStringIsCleared_WhenUserClicksOnClearButton() {
        ...
        composeTestRule.onNodeWithTag(composeTestRule.activity.getString(com.github.thangdev99.presentation.R.string.clear_search))
            .performClick()
    ...
    fun emptyStateIsDisplayed_WhenNewsListIsEmpty() {
        ...
        composeTestRule.onNodeWithText(composeTestRule.activity.getString(com.github.thangdev99.presentation.R.string.no_news_available))
            .assertIsDisplayed()
    }
    ...
    fun loadingStateIsDisplayed_WhenNewsListIsLoading() {
        ...
        composeTestRule.onNodeWithTag(composeTestRule.activity.getString(com.github.thangdev99.designsystem.R.string.loading_state_component))
            .assertIsDisplayed()
    }
}
